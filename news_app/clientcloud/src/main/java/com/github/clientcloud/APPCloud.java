...
public class APPCloud {
    ...
    public static APPCloud.Initialize getInitializer() {
        return new APPCloud.Initialize();
    }

    public static APPCloud getInstance() {
        if (!APPCloud.SingletonHolder.isInitialized.get()) {
            throw new IllegalStateException("ERROR! Not initialized!");
        } else {
            return APPCloud.SingletonHolder.instance;
        }
    }

    private static class SingletonHolder {
        static AtomicBoolean isInitialized = new AtomicBoolean(false);
        static APPCloud instance = new APPCloud();
    }
    ...
    private APPCloud initialize(Initialize initialize) {
